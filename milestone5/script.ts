document.addEventListener('DOMContentLoaded', () => {
    ...
    const shareableLinkContainer = document.querySelector('.shareable-link-container') as HTMLDivElement;
    ...
    form.addEventListener('submit', (event: Event) => {
        ...
        localStorage.setItem(username, JSON.stringify(resumeData)); // Store resume data
